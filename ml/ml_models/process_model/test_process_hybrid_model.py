...
def test_process_hybrid_model():
    ...
    # =====================================================
    print("\n" + "=" * 72)
    print("PROCESS HYBRID MODEL - FULL DATASET TEST")
    print("=" * 72)
    ...
    # =====================================================
    print("\n" + "=" * 72)
    print("TOP 10 MOST SUSPICIOUS PROCESS EVENTS")
    print("=" * 72)
...
if __name__ == "__main__":
    pred_df, states = test_process_hybrid_model()